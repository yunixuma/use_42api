...
data_dir = BASE_DIR + "/data/userpoint"
...
filepath = login + "_point_" + datetime + ".json"
...
for idx_page in range(1, 200):
    uri = f"/v2/users/{login}/correction_point_historics?page[number]={idx_page}&page[size]=100"
