...
def get_criticalusers_paced(n_days = 28):
    bh_lower = datetime.datetime.now().astimezone((datetime.timezone(datetime.timedelta(hours=+9)))) + datetime.timedelta(days=-2)
